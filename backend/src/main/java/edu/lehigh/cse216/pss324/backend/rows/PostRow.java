...
public class PostRow {
    ...
    public PostRow(int post_id, String title, String message, int user_id, boolean valid, String poster_name, int likes_number, int dislikes_number, ArrayList<CommentRow> comments) {
